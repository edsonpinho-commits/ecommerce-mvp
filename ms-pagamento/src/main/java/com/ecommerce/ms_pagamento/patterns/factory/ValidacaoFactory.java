 ...
 *
 * Sem if/else: o Spring injeta automaticamente um Map com todos os beans
 * que implementam ValidacaoStrategy, usando o nome dado em @Component("pix"),
 * @Component("cartao") etc. como chave.
 */
@Component
